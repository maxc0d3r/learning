...
export class LoginSignupPage implements OnInit {
 ...
 signInWithApple() {
    ...
    window.open(
      `https://appleid.apple.com/auth/authorize?client_id=${CLIENT_ID}&redirect_uri=${encodeURIComponent(environment.apiURL)}&response_type=code id_token&scope=name email&response_mode=form_post`,
      '_self'
  );
